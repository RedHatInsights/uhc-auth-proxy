...
var _ = Describe("Handler", func() {
	...
	Describe("When called with a valid request", func() {
		validOperatorAgents := []string{"insights-operator", "cost-mgmt-operator", "marketplace-operator", "acm-operator", "assisted-installer-operator", "cryostat-operator", "openshift-lightspeed-operator", "jws-operator", "runtimes-inventory-operator"}
